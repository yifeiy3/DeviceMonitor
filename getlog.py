...
IMPORTANT = ["Virtual Switch 2"]  #important devices to keep track of state changes
...
#TODO: Why would this return error when since is not None, figure out time in groovy
since = None
